...
export function chooseLevelBlock(container) {
    ...
    chooseLevelDiv.classList.add('choose_level_div');
    chooseLevelBlockArray.push(chooseLevelDiv);
    const chooseLevelTitle = document.createElement('p');
    chooseLevelTitle.classList.add('choose_level_title');
    ...
    chooseLevelButton.classList.add('choose_level_button');
    ...
    chooseLevelButtonEasy.addEventListener('click', (event) => {
        ...
        chooseLevelButtonEasy.classList.add('level_button_click');
        chooseLevelButtonMedium.classList.remove('level_button_click');
        chooseLevelButtonHard.classList.remove('level_button_click');
    });
    chooseLevelButtonMedium.addEventListener('click', (event) => {
        window.application.level = 'medium';
        chooseLevelButtonMedium.classList.add('level_button_click');
        chooseLevelButtonEasy.classList.remove('level_button_click');
        chooseLevelButtonHard.classList.remove('level_button_click');
    });
    chooseLevelButtonHard.addEventListener('click', (event) => {
        window.application.level = 'hard';
        chooseLevelButtonHard.classList.add('level_button_click');
        chooseLevelButtonEasy.classList.remove('level_button_click');
        chooseLevelButtonMedium.classList.remove('level_button_click');
    });
